...
\begin{figure}[h] % use float package if you want it here
  \centering
  \includegraphics[width=300pt]{vins_framework.png}
...
%\ref{equ:glo_vec}\ref{equ:loc_vec}两式联立消去轮速，可得\ref{equ:mid_equ1}\ref{equ:mid_equ2}，
%将两式合并消去$v_{g1}$，最终得到
...
%\begin{equation}
  %\label{equ:fin_equ}
  %\omega_1 = \frac{1}{R}( 1 \frac{1}{tan\alpha} -(L_1 + \frac{L_2}{tan\alpha}) )
